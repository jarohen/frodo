...
*I'm no longer maintaining Frodo (not that it needed much maintenance anyway!) because the Clojure-world has moved on. I'd recommend checking out Stuart Sierra's [[https://github.com/stuartsierra/component][Component]] library, or my own [[https://github.com/jarohen/yoyo][Yo-yo]] library.*
